...
public static class SettingFileProcessing
{
    ...
    /// 設定ファイルのファイル名
    /// </summary>
    private static string SettingFileName { get; } = "CSharpScriptProcessSetting.ini";
    ...
    private static string GetSettingFilePath() => Path.Combine(PluginData.SettingDirectoryPath, SettingFileName);
}
